...
public class FirmwareVersionAxolotlDetailPreferenceController extends BasePreferenceController {
    ...
    public FirmwareVersionAxolotlDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        if (mHits[0] >= (SystemClock.uptimeMillis() - DELAY_TIMER_MILLIS)) {
            ...
            final Intent intent = new Intent(Intent.ACTION_MAIN)
                    .setClassName(
                            "Axolotl Android", com.android.internal.app.PlatLogoActivity.class.getName());/*This PlatLogo can be changed in the future ;) */
            try {
